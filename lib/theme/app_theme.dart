...
class AppTheme {
  ...
  // Fresh Green Foundation Color Palette
  static const Color primaryLight = Color(0xFF4CAF50);
  static const Color primaryVariantLight = Color(0xFF81C784);
  ...
  // Shadow colors (2dp and 4dp Material Design values)
  ...
  /// Light theme optimized for food delivery experience
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      tertiaryContainer: primaryVariantLight,
